...
oauthModule.submodule('basecamp')
  ...
  .fetchOAuthUser( function (accessToken) {
    ...
    this.oauth.get(this.apiHost() + '/people/me.xml', { 'headers': { 'Accept': 'application/xml', 'Content-Type': 'application/xml', 'Authorization': 'Token token=' + accessToken } }, function (err, data) {
